...
const restaurantData = {
    ...
    icon: "🍣",
    items: {
        101: { id: 101, name: "Neon Dragon Roll", description: "Spicy tuna, avocado, topped with eel and neon sauce", price: 18.99, rating: 4.9 },
        102: { id: 102, name: "Cyber Rainbow Roll", description: "California roll topped with assorted sashimi", price: 16.99, rating: 4.7 },
        103: { id: 103, name: "Matrix Tempura Roll", description: "Shrimp tempura, cucumber, spicy mayo", price: 14.99, rating: 4.6 },
        104: { id: 104, name: "Premium Sashimi Set", description: "Chef's selection of 12 pieces", price: 24.99, rating: 4.8 },
        105: { id: 105, name: "Salmon Sashimi", description: "Fresh Atlantic salmon, 6 pieces", price: 12.99, rating: 4.7 },
        106: { id: 106, name: "Ramen Fusion", description: "Tonkotsu broth with cyber-enhanced toppings", price: 15.99, rating: 4.8 },
        107: { id: 107, name: "Teriyaki Chicken", description: "Grilled chicken with house teriyaki sauce", price: 13.99, rating: 4.5 }
    }
};
...
function addToCart(itemId, quantity) {
    console.log('addToCart called with:', itemId, quantity);
