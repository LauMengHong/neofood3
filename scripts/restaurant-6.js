...
const restaurantData = {
    ...
    icon: "🔥",
    items: {
        601: { id: 601, name: "Korean BBQ Bowl", description: "Marinated beef, rice, kimchi", price: 16.99, rating: 4.9 },
        602: { id: 602, name: "Thai Curry Ramen", description: "Spicy curry broth with noodles", price: 15.99, rating: 4.8 },
        603: { id: 603, name: "Sushi Tacos", description: "Sushi-grade fish in crispy wonton shells", price: 14.99, rating: 4.7 },
        604: { id: 604, name: "Korean Fried Chicken Tacos", description: "Crispy chicken with gochujang sauce", price: 13.99, rating: 4.8 }
    }
};
