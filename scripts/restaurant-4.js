...
const restaurantData = {
    ...
    icon: "🧋",
    items: {
        401: { id: 401, name: "Classic Milk Tea", description: "Black tea with milk and tapioca pearls", price: 5.99, rating: 4.8 },
        402: { id: 402, name: "Taro Bubble Tea", description: "Creamy taro flavor with chewy pearls", price: 6.49, rating: 4.7 },
        403: { id: 403, name: "Berry Blast", description: "Mixed berries with yogurt", price: 7.99, rating: 4.9 },
        404: { id: 404, name: "Tropical Paradise", description: "Mango, pineapple, coconut", price: 7.49, rating: 4.6 }
    }
};
